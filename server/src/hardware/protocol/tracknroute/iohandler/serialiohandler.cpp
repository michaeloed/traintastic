/**
 * server/src/hardware/protocol/tracknroute/iohandler/serialiohandler.cpp
 *
...
{
  SerialPort::open(m_serialPort, device, 115200, 8, SerialParity::None, SerialStopBits::One, SerialFlowControl::None);
}
